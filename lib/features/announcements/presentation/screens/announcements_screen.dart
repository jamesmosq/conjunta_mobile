      ...
      child: Row(
        children: [
          _FilterChip(
            ...
            selected: !unreadOnly,
            onTap: () =>
                ref.read(announcementsProvider.notifier).setUnreadOnly(false),
          ),
          const SizedBox(width: 8),
          _FilterChip(
            label: 'No leídos',
            selected: unreadOnly,
            onTap: () =>
                ref.read(announcementsProvider.notifier).setUnreadOnly(true),
          ),
        ],
      ),
    );
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 4),
              Text(
                DateFormat('dd \'de\' MMMM \'de\' yyyy, HH:mm', 'es')
                    .format(DateTime.tryParse(a.createdAt)?.toLocal() ??
                        DateTime.now()),
                style: TextStyle(
                    fontSize: 12,
                    color: Theme.of(context).colorScheme.outlineVariant),
